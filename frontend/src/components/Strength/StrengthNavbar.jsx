      ...
      <nav id="aluminiNavbar">
        ...
        <ul id="menu">
          <li className="second" id="menuLink">
            <a href="/strength/second" id="menuLinkactual">
              Second
            </a>
          </li>
          <li className="third" id="menuLink">
            <a href="/strength/third" id="menuLinkactual">
              Third
            </a>
          </li>
          <li className="fourth" id="menuLink">
            <a href="/strength/fourth" id="menuLinkactual">
              Fourth
            </a>
          </li>
          <li className="alumini" id="menuLink">
            <a href="/strength/alumini" id="menuLinkactual">
              Alumni
            </a>
          </li>
          ...
          <li className="quizzitch" id="menuLink">
            <a href="/quizzitchcup" id="menuLinkactual">
              Quizzitch Cup
            </a>
          </li>
        </ul>
